...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Reset Password Mail</li>
			...
			<div class="col-md-12">
				...
				<div class="box box-info">
					...
					<div class="box-header with-border">
						...
						<h3 class="box-title">Update Reset Password Mail</h3>
					...
					<form class="form-horizontal" name="reset-email-template" action="{!! admin_url('reset-email-template') !!}" method="post" enctype="multipart/form-data">
