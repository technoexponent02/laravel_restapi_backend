...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Welcome Mail</li>
			...
			<div class="col-md-12">
				...
				<div class="box box-info">
					...
					<div class="box-header with-border">
						...
						<h3 class="box-title">Update Welcome Mail</h3>
					...
					<form class="form-horizontal" name="welcome-email-template" action="{!! admin_url('welcome-email-template') !!}" method="post" enctype="multipart/form-data">
