...
class UserFriendRequestNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toBroadcast($notifiable)
    {
        ...
        return new BroadcastMessage([
            ...
            'title'        => env('APP_NAME'),
            'body'         => $user_sending_the_request->first_name.' has sent you a friend request',
            'icon'         => env('SITE_URL')."/favicon.ico", // Optional
            'click_action' => env('SITE_URL')."/".$notifiable->username."/friends/firend-request", // Optional
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'url'  => env('SITE_URL')."/".$notifiable->username."/friends/firend-request",
